  ...
  return (
    <section className='flexCenter flex-col '>
      ...
      <div className='flexCenter padding-container max-container relative w-full'>
        <Image src="/boat.png" alt="boat" width={1440} height={580} className='w-full object-cover object-center 2xl:rounded-5xl rounded-5xl'/>
          ...
          <div className='flexBetween flex-col'>
            <div className='flex w-full flex-col'>
              <div className='flexBetween w-full'>
                ...
                <p className='bold-16 text-green-50'>56 min</p>
              </div>
